    ...
    public class OcrService
    {
        ...
        public async Task<string> LeerTextoAsync(IFormFile imagen)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("API Key de OCR.space vacía o no encontrada.");
                }
                ...
                formData.Add(fileContent, "file", imagen.FileName);
                ...
                {
                    throw new Exception(
                        $"OCR.space HTTP {(int)response.StatusCode}: {json}"
                    );
                }
            ...
            {
                throw new Exception(
                    $"ERROR EN OCRSERVICE: {ex.Message}",
                    ex
                );
            }
        }
